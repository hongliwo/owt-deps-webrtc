...
#ifndef MODULES_AUDIO_CODING_CODECS_AAC_AUDIO_CODER_AAC_COMMON_H_
#define MODULES_AUDIO_CODING_CODECS_AAC_AUDIO_CODER_AAC_COMMON_H_
...
class AacFrame : public AudioDecoder::EncodedAudioFrame {
 public:
  ...
  absl::optional<DecodeResult> Decode(
	...
	RTC_LOG(LS_INFO) << "### AAC absl::optional<DecodeResult> Decode";
...
#endif  // MODULES_AUDIO_CODING_CODECS_AAC_AUDIO_CODER_AAC_COMMON_H_
